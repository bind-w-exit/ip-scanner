...
namespace IpScanner.Domain.UnitTests
{
    ...
    public class IpRangeValidatorUnitTests
    {
        ...
        public void ValidateIPRange_ShouldReturnTrue_WhenValidIpRange(string range)
        {
            // Arrange
        ...
        public void ValidateIPRange_ShouldReturnFalse_WhenInvalidIpRange(string range)
        {
            // Arrange
            var validator = new IpRangeValidator();
            var ipRange = new IpRange(range);
